...
`신고가 캘린더` 페이지(`/new-highs`)에서는 달력 날짜별 신고가 종목, 업종·테마별 사유와 기업 설명을 확인합니다. 한국은 코스피를 기본으로 표시하며 코스닥도 선택할 수 있습니다. 52주 신고가와 역대 신고가를 별도로 집계합니다. 신고가는 장 마감 후 거래일당 한 번 자동 수집하고 날짜별로 보관합니다. 자료 미확인과 신고가 0건을 구분합니다.
